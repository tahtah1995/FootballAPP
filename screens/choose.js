...
const choose = ({ navigation }) => {
  ...
  let imagesURL = ["https://i.postimg.cc/J0gMY0XZ/kisspng-segunda-divisin-201617-la-liga-spain-premier-la-liga-5b4cda9b3c6d41-5603605715317633552475.png" ,
...
"https://i.postimg.cc/rF2prJxQ/Png-Item-5317435.png" ,"https://i.postimg.cc/15Vp9JPB/pngkit-bundesliga-logo-png-3062110.png" ,
"https://i.postimg.cc/d0W2Q0NP/pngegg-1.png", "https://i.postimg.cc/SN0Wx3ds/Danish-Superliga-Logo-PNG.png" ,
"https://i.postimg.cc/NMHKhGWx/major-league-logo-primary.png" ,
"https://i.postimg.cc/g06zjSNz/icon-bundesliga-football-germany.png" , "https://i.postimg.cc/4NLs5k04/super-lig-logo-png-6-png-image-sper-lig-png-512-512.png" ,
"https://i.postimg.cc/6pxJzW0X/Eredivisie-Logo-1-696x370.png" ,
"https://i.postimg.cc/YS1s9QKG/kisspng-a-c-milan-italy-football-uefa-champions-league-pes-6-kitpack-serie-a-2-18-2-19-full-pes-6-ar.png" ,
"https://i.postimg.cc/QxGSBHmc/Pin-Clipart-com-celtic-knot-clipart-1965078.png"
    ...
    <View style={styles.cardIcons}>
        ...
        <View style={[ styles.cardIcons ] , {marginTop:-20 , marginRight:270 }}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1] } onPress={()=>changeOpacity()}         >
                <Image style={{ width: 80, height: 80 , opacity:opacity  }} source={{uri:imagesURL[count] }} />
        ...
        <View style={[ styles.cardIcons ] , {marginTop:-120 , marginRight:380}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} onPress={()=>changeOpacity2()}>
                ...
                <Image style={{ width: 80, height: 80 , opacity:opacity4  }} source={{uri:imagesURL[count+1]}} />
        ...
        <View style={[ styles.cardIcons ] , {marginTop:-180 , marginRight:40}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+3]}} />
            </TouchableOpacity>
        </View>

        <View style={[ styles.cardIcons ] , {marginTop:-350 , marginRight:50}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height:50   }} source={{uri:imagesURL[count+4]}} />
            </TouchableOpacity>
        </View>

        <View style={[ styles.cardIcons ] , {marginTop:-210 , marginRight:-280}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+5]}} />
            </TouchableOpacity>
        </View>
        <View style={[ styles.cardIcons ] , {marginTop:-100 , marginRight:280}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+6]}} />
            </TouchableOpacity>
        </View>
        <View style={[ styles.cardIcons ] , {marginTop:-200 , marginRight:-220}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{width: 50, height: 50    }} source={{uri:imagesURL[count+7]}} />
            </TouchableOpacity>
        </View>
        <View style={[ styles.cardIcons ] , {marginTop:-120 , marginRight:-270}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{width: 60, height: 60   }} source={{uri:imagesURL[count+9]}} />
            </TouchableOpacity>
        </View>

        <View style={[ styles.cardIcons ] , {marginTop:-220 , marginRight:370}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+10]}} />
            </TouchableOpacity>
        </View>

        <View style={[ styles.cardIcons ] , {marginTop:-310 , marginRight:-20}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+8]}} />
            </TouchableOpacity>
            
        </View>
        <View style={[ styles.cardIcons ] , {marginTop:-220 , marginRight:180}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 40, height:40   }} source={{uri:imagesURL[count+11]}} />
            </TouchableOpacity>
            
        </View>
        <View style={[ styles.cardIcons ] , {marginTop:-580 , marginRight:-120}}>
            <TouchableOpacity style={[styles.iconProfile, styles.icon1]} >
                <Image style={{ width: 50, height: 50   }} source={{uri:imagesURL[count+12]}} />
            </TouchableOpacity>
